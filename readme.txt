...
then use the prediction in creative way to show the user list of top musics in that specified predicted language. The user can select one of the musics for playback. 
